# Contributing to hyperbee-live-stream
...
Fork the project [on GitHub](https://github.com/geut/hyperbee-live-stream) and check out your copy locally.

```bash
$ git clone git@github.com:username/hyperbee-live-stream.git
$ cd hyperbee-live-stream
$ npm install
$ git remote add upstream git://github.com/geut/hyperbee-live-stream.git
```
